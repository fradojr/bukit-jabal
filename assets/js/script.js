$(function () {
  ...
  var shuffleme = (function( $ ) {
    'use strict';
        ...
        $filterOptions = $('.sop-sorting li'),  //locate the filter categories
    ...
    setupFilters = function() {
      ...
      $btns.on('click', function(e) {
        ...
        if ( !isActive ) {
          $('.sop-sorting li a').removeClass('active');
        }
    ...
    listen = function() {
      ...
      // Because this method doesn't seem to be Jabal.
      setTimeout(function() {
        debouncedLayout();
      }, 500);
    };      
